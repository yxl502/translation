...
from models import EncoderRNN, DecoderRNN, AttenDecoderRNN
from utils import *
...
# pairs = [['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！'],
#          ['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！'],
#          ['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！'],
#          ['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！'],
#          ['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！'],
#          ['I love you baby !', '我爱你贝贝 ！'], ['I love you baby !', '我爱你贝贝 ！']]
...
print('train_sen_pairs', train_sen_pairs)

training_pairs = [
    tensorFromPair(train_sen_pairs[i]) for i in range(n_iters)
]

print('train_sen_pairs', training_pairs)
...
for i in range(1, n_iters+1):
    ...
    print(train_sen_pairs[i-1][0])
    print(train_sen_pairs[i-1][1])
    print(decoder_words)
